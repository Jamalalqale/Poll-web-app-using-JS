...
public class addCheckboxQuestion {
    
       public boolean addCheckboxQuestion(String checkboxQuestion,int questionnaire_id){
          ...
          try {
              ...
              gc.ps.setString(1,checkboxQuestion);
              gc.ps.setInt(2, 3);   
          ...
          return false;
           ...
           public boolean addCheckboxText(List checkboxTextList,int lastQuestionId){
